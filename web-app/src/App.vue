...
<template>
  ...
  <div class="flex  space-grotesk-font container mx-auto w-full text-sm border-b border-t border-blue-800 p-2"> 
    ...
    <div class="xs:w-2/3 w-4/5 flex xs:gap-16 gap-4 ">
      <div class="border border-blue-800 p-2 text-xs xs:text-sm font-medium"> <p class="text-center">Countries <span class="font-bold">89</span></p> </div>
      <div class="border border-blue-800 p-2 text-xs xs:text-sm font-medium"> <p class="text-center">Actors <span class="font-bold">89</span></p> </div>
      <div class="border border-blue-800 p-2 text-xs xs:text-sm font-medium"> <p class="text-center">Actions <span class="font-bold">89</span></p> </div>
    </div>
  </div>
